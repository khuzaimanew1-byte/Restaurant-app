...
export const profSeeds: ProfSeed[] = [
  {
    name: "Alex Rivera",
    ...
    task: ["Backend Development", "Code Review"],
    cap: ["System Design", "API Development"],
    spec: ["Node.js", "TypeScript"],
  },
  {
    name: "Sarah Chen",
    role: "UX Designer",
    ...
    task: ["UI Design", "User Research"],
    cap: ["Prototyping", "Figma"],
    spec: ["Mobile UX", "Design Systems"],
  },
  {
    name: "James Wilson",
    ...
    lang: ["English"],
    task: ["Roadmap Planning", "Stakeholder Management"],
    cap: ["Strategic Thinking", "Agile"],
  ...
  },
  {
    ...
    lang: ["English", "Spanish"],
    task: ["Data Analysis", "Report Generation"],
    cap: ["SQL", "Python"],
  ...
  },
  {
    ...
    task: ["Meal Preparation", "Inventory Management"],
    cap: ["Culinary Arts", "Kitchen Management"],
    spec: ["Asian Cuisine"],
  },
  {
    name: "Olivia Smith",
    ...
    img: "https://lh3.googleusercontent.com/aida-public/AB6AXuBn9FUaoKfhISyk0i7541LCL_Wne8GVJqIZ5Kh4R4-k1T2CNR9nrJseDhLdCVFn0IVlGMCi3ObqXLAW1heQFm2c3UAy58EAoLwiIvUyFxWlz0MnUYbGctN9HdTwRXf0JXR5U-IMcikQ6OzWsuSLyz8xCd74xF4ZOlicwh4v0K4Wntug0_hOAQg190FMP14qIg74oI478NPbXIiNLNjMhaIrWFNdZrVKsLWc7eTn_715wWnZK8ESsznSD5kJOA_BmCV3zQcCgm1s5-S5r",
    lang: ["English", "French"],
    task: ["Staff Management", "Customer Service"],
    cap: ["Leadership", "Operations"],
    spec: ["Hospitality Management"],
  },
];

export const stSeeds: StSeed[] = [
