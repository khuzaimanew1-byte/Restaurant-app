        ...
        <div className="adm-inline-edit adm-inline-edit-top">
          <div className="adm-inline-time-row">
            <div className="adm-inline-field">
              <span className="adm-inline-label">IN</span>
              <input
            ...
            <div className="adm-inline-field">
              <span className="adm-inline-label">OUT</span>
              <input
          ...
          <div className="adm-card-info">
            ...
            {!isEditing && (isLeave ? (
              ...
              <div className="adm-times">
                <span className="adm-time-in" style={arrColor ? { color: arrColor } as React.CSSProperties : undefined}>
                  {CHECKIN_SVG}
                  <span className={emp.checkIn ? "" : "adm-time-placeholder"}>{displayIn}</span>
                </span>
                <span className="adm-time-out" style={depColor ? { color: depColor } as React.CSSProperties : undefined}>
                  {CHECKOUT_SVG}
