...
import { Navbar, AvatarDropdown, type NavItem } from "./Navbar";
...
export function AdminDashboard({ onLogout }: { onLogout: () => void }) {
  ...
  return (
    <div className="adm-root">
      ...
      {/* ── Sidebar + mobile topbar + mobile bottom nav (Navbar component) ── */}
      <Navbar
        activeNav={activeNav}
        ...
        rawQuery={rawQuery}
        onSearchChange={q => { setRawQuery(q); }}
      ...
      <main className="adm-main">
        ...
        <div className="adm-desktop-stats">
          <span className="chip adm-chip-p">Present: {presentCount}</span>
          {halfDayCount > 0 && (
            <span className="chip adm-chip-h">Half Day: {halfDayCount}</span>
          )}
